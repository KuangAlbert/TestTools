...
void usage(void)
{
	printf("usage: device mode for hub test\n");
	printf("hub_dev_test_mode\n\n");
}
...
int main(int argc, char **argv)
{
	...
	/* 3) J6 role switch to device mode */
	sprintf(buf, "echo %s > /sys/kernel/debug/48890000.usb/mode", "device");
	system(buf);
